...
function preload(){
  ...
  groundImage = loadImage("assets/ground1.jpg");
...
function setup() {
  ...
  sun = createSprite(900,100,10,10);
  ...
  invisibleGround = createSprite(width/2,height-10,width*100,125);  
...
function draw() {
  ...
  */
    ...
    if(score === 500){
      textSize(30);
      text("You Win", trex.x, height/2-75);
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(trex.x + 1400,height-300,40,10);
...
function spawnObstacles() {
  if(frameCount % 100 === 0) {
    var obstacle = createSprite(trex.x + 1400,height-95,20,30);
